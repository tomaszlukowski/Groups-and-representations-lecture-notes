...
# - $\theta=1$. Then $w=v$ because otherwise the subspace spanned by $v+w$ would be a one-dimensional invariant subspace of $V$, and therefore $V$ would not be irreducible. Then $V$ is one-dimensional and we know that $\sigma$ acts triviall on it. Now, since $\tau^2=e$ we have only two options:
